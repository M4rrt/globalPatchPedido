...
class Linha extends Component {
    render() {
        const { produto, tamanho, especificacao, quantidade, precoBruto, montante, classNames, id, onFocus, onChange, removeLine, onChangeProduto, onChangeTamanho } = this.props;
        return (
            <div className={`linha`}>
                ...
                <div className={`celula ${classNames[5]}`}>
                    ...
                    <button>
                        <svg onClick={(event) => removeLine(event, id)} xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#fff" className="bi bi-x-circle" viewBox="0 0 16 16">
